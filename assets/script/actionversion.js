    ...
    start () {
        ...
        let loopcallback=()=>{
                    ...
                    if(turn_store != turn) {// 下一轮已开始
                        ...
                        if (turn_store == true) {// 到你的回合了，展示对手上一回合动画
                            ...
                            if (type == '0' || begin == "对局刚开始") {
                                    ...
                                    if (layer.length == 0) {
                                        ...
                                        if (layer[layer.length-1][0] != card_kind) {
                                            ...
                                            for(let i=0; i<layer.length; i++) {
                                                ...
                                                if (layer[i][0] == 'C') {
                                                    let spawn = cc.spawn(cc.moveTo(1, -280, 232), cc.scaleTo(1, 1.667, 1.667));
                                                    action.push(false);
                                                    let index_now = action.length-1;
                                                    let seq = cc.sequence(spawn, cc.callFunc(function(target, index){
                                                        action[index] = true;
                                                    }, this, index_now));
                                                    ...
                                                    let spawn = cc.spawn(cc.moveTo(1, -81, 232), cc.scaleTo(1, 1.667, 1.667));
                                                    action.push(false);
                                                    let index_now = action.length-1;
                                                    let seq = cc.sequence(spawn, cc.callFunc(function(target, index){
                                                        action[index] = true;
                                                    ...
                                                    let spawn = cc.spawn(cc.moveTo(1, 119, 232), cc.scaleTo(1, 1.667, 1.667));
                                                    action.push(false);
                                                    let index_now = action.length-1;
                                                    let seq = cc.sequence(spawn, cc.callFunc(function(target, index){
                                                        action[index] = true;
                                                    ...
                                                    let spawn = cc.spawn(cc.moveTo(1, 321, 232), cc.scaleTo(1, 1.667, 1.667));
                                                    action.push(false);
                                                    let index_now = action.length-1;
                                                    let seq = cc.sequence(spawn, cc.callFunc(function(target, index){
                                                        action[index] = true;
                                ...
                                let index_now = action.length-1;
                                cc.log('555555555555')
                                let seq = cc.sequence(cc.moveTo(1, 99, 43), cc.callFunc(function(target, index){
                                    finished();
                                    action[index] = true;
                                }, this, index_now));
                                ...
                                action.push(false);
                                let index_now = action.length-1;
                                let spawn1 = cc.spawn(cc.moveTo(1, 99, 43), cc.scaleTo(1, 1, 1));
                                let seq = cc.sequence(spawn1, cc.callFunc(function(target, index){
                                    finished();
                                    action[index] = true;
                                }, this, index_now));
                                card_now.zIndex = epoch++;
                                    ...
                                    if (layer.length == 0) {
                                        ...
                                        if (layer[layer.length-1][0] != card_kind) {
                                            ...
                                            for(let i=0; i<layer.length; i++) {
                                                let card_now = cc.find("Canvas/New Sprite(Splash)/"+layer[i]);
                                                if (layer[i][0] == 'C') { 
                                                    let spawn = cc.spawn(cc.moveTo(1, -280, -219), cc.scaleTo(1, 1.667, 1.667));
                                                    action.push(false);
                                                    let index_now = action.length-1;                                                    
                                                    let seq = cc.sequence(spawn, cc.callFunc(function(target, index){
                                                        action[index] = true;
                                                    ...
                                                    let spawn = cc.spawn(cc.moveTo(1, -81, -219), cc.scaleTo(1, 1.667, 1.667));
                                                    action.push(false);
                                                    let index_now = action.length-1;
                                                    let seq = cc.sequence(spawn, cc.callFunc(function(target, index){
                                                        action[index] = true;
                                                    ...
                                                    let spawn = cc.spawn(cc.moveTo(1, 119, -219), cc.scaleTo(1, 1.667, 1.667));
                                                    action.push(false);
                                                    let index_now = action.length-1;
                                                    let seq = cc.sequence(spawn, cc.callFunc(function(target, index){
                                                        action[index] = true;
                                                    ...
                                                    let spawn = cc.spawn(cc.moveTo(1, 321, -219), cc.scaleTo(1, 1.667, 1.667));
                                                    action.push(false);
                                                    let index_now = action.length-1;
                                                    let seq = cc.sequence(spawn, cc.callFunc(function(target, index){
                                                        action[index] = true;
            ...
            for(let i=0; i<action.length; i++) {
                if(action[i] == false) {flag = 0;break;}
            }
            if (flag == 1) {
        ...
        if(begin == '') {
            this.schedule(loopcallback, 0.01);
        }
